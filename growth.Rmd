...
plot bar chart (y is categories, sobol score is x axis)
two plots (t = total, s = first order)
mean and max of s and t
x1, x2, x3, x4 are the parameters and are the names we called it in our scripts
